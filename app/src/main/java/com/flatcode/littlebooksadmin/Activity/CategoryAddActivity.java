...
public class CategoryAddActivity extends AppCompatActivity {
    ...
    private void createCategoryInDB() {
        dialog.setMessage("Creating Category...");
        dialog.show();
        ...
        ref.child(id).setValue(hashMap).addOnSuccessListener(unused -> {
            ...
            dialog.dismiss();
            Toast.makeText(context, "Failed to create category due to: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        });
    }
