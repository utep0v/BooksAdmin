...
//        Main item1 = new Main(R.drawable.ic_person, "Users", users, CLASS.USERS);
        Main item2 = new Main(R.drawable.ic_add, "Добавить книгу", 0, CLASS.BOOK_ADD);
        Main item3 = new Main(R.drawable.ic_book_white, "Мои книги", myBooks, CLASS.MY_BOOKS);
        Main item4 = new Main(R.drawable.ic_books, "Все книги", allBooks, CLASS.ALL_BOOKS);
        Main item5 = new Main(R.drawable.ic_rank, "Лучший издатель", publishers, CLASS.TOP_PUBLISHERS);
        Main item6 = new Main(R.drawable.ic_users, "Выбор редакторов", editorsChoice, CLASS.EDITORS_CHOICE);
        Main item7 = new Main(R.drawable.ic_add_category, "Добавить категорию", 0, CLASS.CATEGORY_ADD);
        Main item8 = new Main(R.drawable.ic_category_gray, "Категории", categories, CLASS.CATEGORIES);
        Main item9 = new Main(R.drawable.ic_slider, "Слайд-шоу", sliderShow, CLASS.SLIDER_SHOW);
        Main item10 = new Main(R.drawable.ic_followers, "Последователи", followers, CLASS.FOLLOWERS);
        Main item11 = new Main(R.drawable.ic_following, "Следующий", following, CLASS.FOLLOWING);
        Main item12 = new Main(R.drawable.ic_star_selected, "Избранное", favorites, CLASS.FAVORITES);
//        Main item13 = new Main(R.drawable.ic_ads, "AD's", ads, CLASS.ADS);
        Main item14 = new Main(R.drawable.ic_privacy_policy, "Политика конфиденциальности", 0, CLASS.PRIVACY_POLICY);
//        list.add(item1);
        list.add(item2);
        list.add(item3);
        list.add(item4);
